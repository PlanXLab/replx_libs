...
def rgb_to_hsv(r: int, g: int, b: int) -> tuple[int, float, float]:
    ...
    This function performs the inverse operation of hsv_to_rgb, converting
    standard RGB color values (0-255) into the HSV color model which is often
    more intuitive for color manipulation and analysis.
    
    :param r: Red component (0-255)
    :param g: Green component (0-255)
    :param b: Blue component (0-255)
    :return: Tuple of (hue, saturation, value) where:
             - hue: 0-359 degrees on the color wheel
             - saturation: 0.0-1.0 (0=gray, 1=full color)
             - value: 0.0-1.0 (0=black, 1=full brightness)
    
    Example
    -------
    Basic color conversions::
    
        >>> rgb_to_hsv(255, 0, 0)      # Red: (0, 1.0, 1.0)
        >>> rgb_to_hsv(0, 255, 0)      # Green: (120, 1.0, 1.0)
        >>> rgb_to_hsv(0, 0, 255)      # Blue: (240, 1.0, 1.0)
        >>> rgb_to_hsv(255, 255, 255)  # White: (0, 0.0, 1.0)
        >>> rgb_to_hsv(0, 0, 0)        # Black: (0, 0.0, 0.0)
    
    Hue shifting example::
    
        >>> def hue_shift(color, degrees):
        ...     h, s, v = rgb_to_hsv(color[0], color[1], color[2])
        ...     return hsv_to_rgb((h + degrees) % 360, s, v)
        >>> 
        >>> original = (255, 0, 0)  # Red
        >>> shifted = hue_shift(original, 120)  # Shift by 120° -> Green
    """
